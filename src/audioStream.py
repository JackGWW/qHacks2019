...
gcp_credential_path = os.path.join(CUR_PATH, '..', gcp_credential.json')
...
class AudioGenerator(threading.Thread):
    def __init__(self):
        ...
        self.t = ''
        self.crutch = {}
		self.crutch_words = ['like', ' so', ' you know', 'basically', ' cuz', 'things', 'stuff', 'yeah']
            ...
            try:
                for response in responses:
                    ...
                    # End of sentence
                        ...
                        start = time.time()
						for word in self.crutch_words:
							total_bad_words[word] = cur_bad_words[word]
            except:
                pass
